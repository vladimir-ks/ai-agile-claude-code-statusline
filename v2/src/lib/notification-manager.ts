...
export type NotificationType = 'version_update' | 'version_mismatch' | 'slot_switch' | 'restart_ready' | 'secrets_detected' | 'active_slot' | 'quota_stale' | 'quota_reset_passed' | 'transcript_sampler_dead' | 'weekly_quota_waste_certain' | 'weekly_quota_waste_likely';
